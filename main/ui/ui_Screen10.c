...
void ui_Screen10_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Image44, LV_SIZE_CONTENT);   /// 70
    lv_obj_set_height(ui_Image44, LV_SIZE_CONTENT);    /// 70
    lv_obj_set_x(ui_Image44, -447);
    lv_obj_set_y(ui_Image44, 247);
    lv_obj_set_align(ui_Image44, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_Image44, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
